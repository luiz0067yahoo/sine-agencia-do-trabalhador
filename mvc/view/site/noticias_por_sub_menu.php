...
<div class="row mt-3 block-row-2">
	...
	<div class="col-sm-3 h-100" >
		<div class="h-25 pt-3  menu<?php echo $menu_index;?>"><a class="link-color-<?php echo $menu_index;?> " href="http://tooeste.com.br/ler/<?php echo $url;?>"><?php echo $titulo;?></a></div>
		<div class="w-100 h-75 bg-menu-<?php echo $menu_index;?> " >
			<?php if(isset($foto_principal)){?>
			<a href="http://tooeste.com.br/ler/<?php echo $url;?>"><img src="http://tooeste.com.br/uploads/noticias/320x240/<?php  echo $foto_principal;?>" class="w-100 h-100"></a>
			<?php }?>
		</div>
	</div>
	<?php }?>
...
<div class="row mt-3 block-row-2">
	...
	?>
	<div class="col-sm-3">
		<a href="http://tooeste.com.br/ler/<?php echo $url;?>" style="text-decoration:none;">
		<div class="card overflow-hidden w-100">
			<div class="row no-gutters">
				<div class="col-md-4">
					
					<?php if(isset($foto_principal)){?>
						<img src="http://tooeste.com.br/uploads/noticias/320x240/<?php  echo $foto_principal;?>" class="card-img">
					<?php }?>
				</div>
				<div class="col-md-8">
...
<div class="row mt-3 block-row-2">
	...
	?>
	<div class="col-sm-3 h-100" >
		<div class="h-25 pt-3  menu<?php echo $menu_index;?>"><a class="link-color-<?php echo $menu_index;;?> " href="http://tooeste.com.br/ler/<?php $url;?>"><?php echo $titulo;?></a></div>
		<div class="w-100 h-75 bg-menu-<?php echo $menu_index;?> " >
			<?php if(isset($foto_principal)){?>
			<a href="http://tooeste.com.br/ler/<?php echo $url;?>"><img src="http://tooeste.com.br/uploads/noticias/320x240/<?php  echo $foto_principal;?>" class="w-100 h-100"></a>
			<?php }?>
